const validator = {  
  isValid: function (creditCardNumber) {
    const stringInvertido = creditCardNumber.split("").reverse().join("");/*split dividir una cadena en una matriz*/ 
   /*join array a cadena*/
    let validador;
    let sumaTotal = 0;
    let sumaDigitos = 0;
...
for (let i = 1; i < stringInvertido.length; i += 2) {
      ...
      let numeroPar = parseInt(stringInvertido.charAt(i) * 2);/*te devuelve el
       caracter que le pides de una cadena*/
